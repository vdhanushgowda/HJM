...
import 'package:jala/Products_data/products_muttonlist.dart';
...
class _MuttoncategoryState extends State<Muttoncategory> {
  ...
  void initState() {
    ...
    isAdded = List<bool>.filled(productMutton.length, false);
  }
                        ...
                        children: [
                          ...
                          ElevatedButton(
                            onPressed: ()  {
                              ...
                              CartManager().addToCart(productMutton[index], 1); // Default quantity 1
