...
class _FishcategoryState extends State<Fishcategory> {
  ...
  void initState() {
    ...
    isAdded = List<bool>.filled(productFish.length, false);
  }
                              ...
                              children: [
                                Expanded(
                                  child: Padding(
                                    ...
                                    child: Text(
                                      "${productFish[index]['itemDescription']}",
                                      style: TextStyle(
                                        color: Colors.black,
                                        fontSize: 13,
                                      ),
                                ...
                                ElevatedButton(
                                  onPressed: () {
                                    ...
                                    CartManager().addToCart(productFish[index], 1); // Default quantity 1
