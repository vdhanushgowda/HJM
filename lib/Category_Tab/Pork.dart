...
class PorkPage extends StatefulWidget {
  ...
  PorkPage({required this.selectedCategory});

  @override
  _PorkPageState createState() => _PorkPageState();
}
...
class _PorkPageState extends State<PorkPage> {
  ...
  final List<Map<String, dynamic>> products = [
    {
      'category': 'Curry Cuts',
      'imageUrl': 'assets/Pork/shoulder-of-pork-main-2048x1568.jpg',
    ...
    {
      'category': 'Curry Cuts',
      'imageUrl': 'assets/Pork/prok-belly.jpg',
    ...
    {
      'category': 'Boneless & Mince',
      'imageUrl': 'assets/Pork/BACON-SHORT-CUT-RINDLESS-1000x1000.jpg',
    ...
    {
      'category': 'Speciality Cuts',
      'imageUrl': 'assets/Pork/Pork-Spare-Without-Fat-300x169.jpg',
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  CategoryButton(
                    title: 'Curry Cuts',
                    isSelected: selectedCategory == 'Curry Cuts',
                    onTap: () {
                      setState(() {
                        selectedCategory = 'Curry Cuts';
                      });
                    },
                  ),
                  CategoryButton(
                    title: 'Boneless & Mince',
                    isSelected: selectedCategory == 'Boneless & Mince',
                    onTap: () {
                      setState(() {
                        selectedCategory = 'Boneless & Mince';
                      });
                    },
                  ),
                  CategoryButton(
