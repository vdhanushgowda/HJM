...
class FishPage extends StatefulWidget {
  ...
  FishPage({required this.selectedCategory});
  ...
  final List<Map<String, dynamic>> products = [
    {
      ...
      'imageUrl': 'assets/SeaFood/indian-basa-fish-fillet.png',
    ...
    {
      'category': 'Fresh Water',
      'imageUrl': 'assets/SeaFood/surmai-king-fish-fresh-fish--500x500 anjal.webp',
    ...
    {
      'category': 'Sea Water',
      'imageUrl': 'assets/SeaFood/seer_fish_steak_catalogue anjal.jpg',
    ...
    {
      'category': 'Sea Water',
      'imageUrl': 'assets/SeaFood/catla-fish.jpeg',
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  CategoryButton(
                    title: 'Fresh Water',
                    isSelected: selectedCategory == 'Fresh Water',
                    onTap: () {
                      setState(() {
                        selectedCategory = 'Fresh Water';
                      });
                    },
                  ),
                  CategoryButton(
                    title: 'Sea Water',
                    isSelected: selectedCategory == 'Sea Water',
                    onTap: () {
                      setState(() {
                        selectedCategory = 'Sea Water';
                      });
                    },
                  ),
                ],
