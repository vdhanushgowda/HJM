...
class MuttonPage extends StatefulWidget {
  ...
  MuttonPage({required this.selectedCategory});
...
class _MuttonPageState extends State<MuttonPage> {
  ...
  final List<Map<String, dynamic>> products = [
    {
      'category': 'Chop Cuts',
      'imageUrl': 'assets/Mutton/161-mutton-chops_1.jpg',
    ...
    {
      'category': 'Chop Cuts',
      'imageUrl': 'assets/Mutton/FRESH-MUTTON-BONE-IN-500-GM.webp',
    ...
    {
      'category': 'Boneless',
      'imageUrl': 'assets/Mutton/FRESH-MUTTON-CURRY-CUT.jpg',
    ...
    {
      'category': 'Legs',
      'imageUrl': 'assets/Mutton/MuttonBonesFresh.webp',
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  CategoryButton(
                    title: 'Chop Cuts',
                    isSelected: selectedCategory == 'Chop Cuts',
                    onTap: () {
                      setState(() {
                        selectedCategory = 'Chop Cuts';
                      });
                    },
                  ),
                  CategoryButton(
                    title: 'Boneless',
                    isSelected: selectedCategory == 'Boneless',
                    onTap: () {
                      setState(() {
                        selectedCategory = 'Boneless';
                      });
                    },
                  ),
                  CategoryButton(
                    title: 'Legs',
                    isSelected: selectedCategory == 'Legs',
                    onTap: () {
                      setState(() {
